...
-- Retroactive achievement script removed — it was bulk-awarding achievements
-- incorrectly every time this file was executed. Achievements are now earned
-- only through gameplay via check_and_award_achievements().
